...
const SLOTS = [
    ...
    // ---- ช่องที่ 3 ----
    [
        { name: "Cha Eun-Woo", description: "Favorite actor", image: "https://c.tenor.com/bpUgoSrZzuIAAAAd/tenor.gif" },
        { name: "Character 2", description: "test", image: "https://c.tenor.com/bpUgoSrZzuIAAAAd/tenor.gif" },
        { name: "Character 3", description: "test", image: "https://c.tenor.com/bpUgoSrZzuIAAAAd/tenor.gif" },
        { name: "Character 4", description: "test", image: "https://c.tenor.com/bpUgoSrZzuIAAAAd/tenor.gif" },
        { name: "Character 5", description: "test", image: "https://c.tenor.com/bpUgoSrZzuIAAAAd/tenor.gif" },
    ],
    // ---- ช่องที่ 4 ----
    [
